...
//        String sampleNumber = args[0];
        ...
        String queueName = "xsltTransformer";
//        String queueName = "test123";
...
//                        List<String> messagesList = JMSClientUtil.readFile(filePath);
                        try {
                            ...
                            log.info("Sending  " + " messages on '" + topicName + "' topic");
                            JMSClientUtil.publishTextMessage(producer, session);
...
//                        List<String> messagesList = JMSClientUtil.readFile(filePath);
                        try {
                                ...
                                log.info("Sending  " + " messages on '" + queueName + "' queue");
                                JMSClientUtil.publishFLIFOTextMessage(producer, session);
